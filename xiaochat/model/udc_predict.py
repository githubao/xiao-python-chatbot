...
from xiaochat.model import udc_hparams, udc_model
...
if __name__ == '__main__':
    ...
    estimator._target_info = tf.contrib.learn.estimators.tonsor_signature.TensorSignature(tf.constant(0, shape=[1, 1]))
